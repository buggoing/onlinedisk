...
create table user(
  user_name varchar(16) PRIMARY KEY NOT NULL,/* 用户名，最多32个字节           */
  user_password char(41) NOT NULL,           /* 密码，明文密码经SHA1加密后的值 */
  user_login datetime NOT NULL,              /* 注册时间，YYYY-MM-DD HH:MM:SS  */
  user_pc enum("Y", "N") NOT NULL,           /* pc端是否登录                   */
  user_web enum("Y", "N") NOT NULL,          /* web端是否登录                  */
  user_signup datetime NOT NULL,             /* 最后一次登录时间               */
  user_ip int unsigned NOT NULL              /* 最后一次登录ip                 */
